...
.LBB0_3:                                #   Parent Loop BB0_2 Depth=1
	...
	movss	4096(%rbx,%rcx,4), %xmm0 # xmm0 = mem[0],zero,zero,zero
	addss	4096(%r15,%rcx,4), %xmm0
	movss	%xmm0, 4096(%r14,%rcx,4)
	movss	4100(%rbx,%rcx,4), %xmm0 # xmm0 = mem[0],zero,zero,zero
	addss	4100(%r15,%rcx,4), %xmm0
	movss	%xmm0, 4100(%r14,%rcx,4)
	movss	4104(%rbx,%rcx,4), %xmm0 # xmm0 = mem[0],zero,zero,zero
	addss	4104(%r15,%rcx,4), %xmm0
	movss	%xmm0, 4104(%r14,%rcx,4)
	movss	4108(%rbx,%rcx,4), %xmm0 # xmm0 = mem[0],zero,zero,zero
	addss	4108(%r15,%rcx,4), %xmm0
	movss	%xmm0, 4108(%r14,%rcx,4)
	addq	$4, %rcx
	jne	.LBB0_3
