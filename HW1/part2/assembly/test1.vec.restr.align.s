...
.LBB0_3:                                #   Parent Loop BB0_2 Depth=1
	...
	movaps	4096(%rbx,%rcx,4), %xmm0
	movaps	4112(%rbx,%rcx,4), %xmm1
	addps	4096(%r15,%rcx,4), %xmm0
	addps	4112(%r15,%rcx,4), %xmm1
	movaps	%xmm0, 4096(%r14,%rcx,4)
	movaps	%xmm1, 4112(%r14,%rcx,4)
	movaps	4128(%rbx,%rcx,4), %xmm0
	movaps	4144(%rbx,%rcx,4), %xmm1
	addps	4128(%r15,%rcx,4), %xmm0
	addps	4144(%r15,%rcx,4), %xmm1
	movaps	%xmm0, 4128(%r14,%rcx,4)
	movaps	%xmm1, 4144(%r14,%rcx,4)
	addq	$16, %rcx
	jne	.LBB0_3
