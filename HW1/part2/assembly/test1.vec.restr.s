...
.LBB0_3:                                #   Parent Loop BB0_2 Depth=1
	...
	movups	4096(%rbx,%rcx,4), %xmm0
	movups	4112(%rbx,%rcx,4), %xmm1
	movups	4096(%r15,%rcx,4), %xmm2
	addps	%xmm0, %xmm2
	movups	4112(%r15,%rcx,4), %xmm0
	addps	%xmm1, %xmm0
	movups	%xmm2, 4096(%r14,%rcx,4)
	movups	%xmm0, 4112(%r14,%rcx,4)
	movups	4128(%rbx,%rcx,4), %xmm0
	movups	4144(%rbx,%rcx,4), %xmm1
	movups	4128(%r15,%rcx,4), %xmm2
	addps	%xmm0, %xmm2
	movups	4144(%r15,%rcx,4), %xmm0
	movups	%xmm2, 4128(%r14,%rcx,4)
	addps	%xmm1, %xmm0
	movups	%xmm0, 4144(%r14,%rcx,4)
	addq	$16, %rcx
	jne	.LBB0_3
