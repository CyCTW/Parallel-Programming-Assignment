...
.LBB0_3:                                #   Parent Loop BB0_2 Depth=1
	...
	vmovaps	4096(%rbx,%rcx,4), %ymm0
	vmovaps	4128(%rbx,%rcx,4), %ymm1
	vmovaps	4160(%rbx,%rcx,4), %ymm2
	vmovaps	4192(%rbx,%rcx,4), %ymm3
	vaddps	4096(%r15,%rcx,4), %ymm0, %ymm0
	vaddps	4128(%r15,%rcx,4), %ymm1, %ymm1
	vaddps	4160(%r15,%rcx,4), %ymm2, %ymm2
	vaddps	4192(%r15,%rcx,4), %ymm3, %ymm3
	vmovaps	%ymm0, 4096(%r14,%rcx,4)
	vmovaps	%ymm1, 4128(%r14,%rcx,4)
	vmovaps	%ymm2, 4160(%r14,%rcx,4)
	vmovaps	%ymm3, 4192(%r14,%rcx,4)
	addq	$32, %rcx
	jne	.LBB0_3
