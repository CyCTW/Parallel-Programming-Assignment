...
.LBB0_3:                                #   Parent Loop BB0_2 Depth=1
	...
	vmovups	4096(%rbx,%rcx,4), %ymm0
	vmovups	4128(%rbx,%rcx,4), %ymm1
	vmovups	4160(%rbx,%rcx,4), %ymm2
	vmovups	4192(%rbx,%rcx,4), %ymm3
	...
	vmovups	%ymm0, 4096(%r14,%rcx,4)
	vmovups	%ymm1, 4128(%r14,%rcx,4)
	vmovups	%ymm2, 4160(%r14,%rcx,4)
	vmovups	%ymm3, 4192(%r14,%rcx,4)
	addq	$32, %rcx
	jne	.LBB0_3
